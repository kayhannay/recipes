...
use common::controller::{MessageType, CommonContext};
use common;
...
pub fn recipe_list(connection: RecipeDatabase, cookies: Cookies) -> Template {
    ...
    let recipe_list_model = RecipeOverviewModel { recipe_names: recipe_list, common: CommonContext { current_user, message: None, message_type: MessageType::None } };
...
pub fn recipe(id: i32, connection: RecipeDatabase, cookies: Cookies) -> Option<Template> {
    ...
    let current_user = common::controller::get_current_user(cookies);
    let model = RecipeModel { recipe: converted_recipe, common: CommonContext { current_user, message: None, message_type: MessageType::None } };
